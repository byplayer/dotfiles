...
def configure(window):
    ...
    # --------------------------------------------------------------------
    # テキストエディタを設定する
    window.editor = "C:/goto/tools/SublimeText/sublime_text.exe"
    ...
    window.launcher.command_list += [
        ...
        ( "RLogin",  window.ShellExecuteCommand( None, "C:/goto/tools/rlogin/RLogin.exe", "", "C:/goto/tools/rlogin" ) ),
        ( "GanttProject",  window.ShellExecuteCommand( None, "C:/goto/tools/GanttProject/ganttproject.exe", "", "C:/goto/tools/GanttProject" ) ),
        ( "afxw",        window.ShellExecuteCommand( None, "C:/goto/tools/afxw/afxw.exe", "", "C:/goto/tools/afxw" ) ),
