...
def configure(window):
    ...
    # --------------------------------------------------------------------
    # テキストエディタを設定する
    window.editor = u"c:/goto/tools/emacs/bin/emacsclientw.exe"
    ...
    window.launcher.command_list += [
        ...
        ( u"emacs",window.command_ShellExecute( None, u"c:/goto/tools/emacs/bin/runemacs.exe", u"", u"C:/Goto/tools/emacs/bin" ) ),
    ]
